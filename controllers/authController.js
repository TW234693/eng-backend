...
const login = async (req, res) => {
    ...
    if(!foundClient && !foundUser){
        ...
        const accessToken = createAccessToken(foundUser, userRoles, accessTokenDuration)
       ...
       const  match = await bcrypt.compare(password, foundClient.password);
        ...
        const accessToken = createAccessToken(foundClient, clientRoles, accessTokenDuration)
